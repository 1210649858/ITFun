...
<head>
    <meta charset="utf-8">
    <title>ITFun_微信后台登录</title>
    <meta name="renderer" content="webkit">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=0">
    <link rel="shortcut icon" href="https://images.itfun.tv/school/images/common/favicon.ico">
...
<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
        ...
        <form action="{{route('admin.login')}}" method="post">
            ...
            <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
                <div class="layui-form-item">
                    ...
                    <input type="text" name="name" id="LAY-user-login-username" lay-verify="required" placeholder="用户名/邮箱/手机号" class="layui-input">
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <button type="submit" class="layui-btn layui-btn-fluid" lay-submit lay-filter="LAY-user-login-submit">
                        登 录
                    </button>
                </div>
            </div>
    ...
    <div class="layui-trans layadmin-user-login-footer">
        ...
        <p>Copyright © 2013-2018
            <a href="http://www.miitbeian.gov.cn/" target="_blank">鄂ICP备18025029号-1</a>
        </p>
        <p>
